...
export interface ElementsIconGroup extends Struct.ComponentSchema {
  collectionName: 'components_elements_icon_groups';
  info: {
...
export interface LayoutBackground extends Struct.ComponentSchema {
  collectionName: 'components_layout_backgrounds';
  info: {
    displayName: 'background';
  };
  attributes: {
    background: Schema.Attribute.Enumeration<['white', 'gray']>;
  };
}
...
export interface SectionsServicesBlock extends Struct.ComponentSchema {
  collectionName: 'components_sections_services_blocks';
  info: {
    description: '';
  ...
  attributes: {
    background: Schema.Attribute.Enumeration<['white', 'gray']>;
    description: Schema.Attribute.Text;
    services: Schema.Attribute.Component<'elements.icon-group', true>;
    title: Schema.Attribute.String;
  };
}

export interface SectionsStartSection extends Struct.ComponentSchema {
  collectionName: 'components_sections_start_sections';
  info: {
    description: '';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ComponentSchemas {
      ...
      'elements.icon-group': ElementsIconGroup;
      ...
      'sections.services-block': SectionsServicesBlock;
      'sections.start-section': SectionsStartSection;
